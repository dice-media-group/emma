...
class WallpapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallpaper" do
    assert_difference('Wallpaper.count') do
      post wallpapers_url, params: { wallpaper: { device_size: @wallpaper.device_size, title: @wallpaper.title } }
    end
  ...
  test "should update wallpaper" do
    patch wallpaper_url(@wallpaper), params: { wallpaper: { device_size: @wallpaper.device_size, title: @wallpaper.title } }
